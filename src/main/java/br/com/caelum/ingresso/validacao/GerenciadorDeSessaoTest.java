...
public class GerenciadorDeSessaoTest {
	...
	public void garanteQueNaoDevePermitirSessaoNoMesmoHorario() {
		Filme filme = new Filme("Rogue One", Duration.ofMinutes(120), "Ficção", BigDecimal.ONE);
		filme.setDuracao(120);
		LocalTime horario = LocalTime.now();

		Sala sala = new Sala("Sala A", BigDecimal.ONE);
	...
	public void garanteQueDevePermitirUmaInsercaoEntreDoisFilmes() {
		Sala sala = new Sala("Sala A", BigDecimal.ONE);
		Filme filme1 = new Filme("Rogue One", Duration.ofMinutes(120), "Ficção", BigDecimal.ONE);
		filme1.setDuracao(90);
		LocalTime dezHoras = LocalTime.parse("10:00:00");
		Sessao sessaoDasDez = new Sessao(dezHoras, filme1, sala);
		
		Filme filme2 = new Filme("Rogue One", Duration.ofMinutes(120), "Ficção", BigDecimal.ONE);
